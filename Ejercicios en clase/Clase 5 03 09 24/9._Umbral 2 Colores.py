...
if imagen_color is None:
    ...
    np.savetxt('imagen_umbralizada_2_colores.csv', imagen_umbralizada, delimiter=',', fmt='%d')
    print("La matriz de la imagen umbralizada se ha guardado en 'imagen_umbralizada_2_colores.csv'.")
